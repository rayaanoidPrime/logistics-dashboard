...
const OverviewCard = () => {
    return (
        <View style={styles.OverviewContainer}>
            ...
            <View style={styles.overviewCard}>
                <View style={styles.col}>
                    <Text style={styles.cardTitle}>In Transit</Text>
                    <Text style={{ fontSize: 20, marginTop: 10, color: colours.french_gray['700'] }}>40</Text>
                </View>
                <View style={styles.cardIcon}>
                    <View
                        style={{
                            ...
                            width: 60,
                            borderRadius: 30,
                            backgroundColor: colours.sgbus_green['300'],
                            borderColor: colours.sgbus_green['400'],
                            borderWidth: 1,
                            opacity: 0.7,
                        }}
                    >
                ...
                <View style={styles.cardIcon}>
                    <View
                        style={{
                            ...
                            width: 60,
                            borderRadius: 30,
                            backgroundColor: colours.auburn['300'],
                            borderColor: colours.auburn['400'],
                            borderWidth: 1,
                            opacity: 0.7,
                        }}
                    >
